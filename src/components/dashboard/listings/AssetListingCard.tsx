...
import { Asset } from "@/types/business";
...
const AssetListingCard = ({ listing, onEdit }: AssetListingCardProps) => {
  return (
      ...
      <CardContent className="p-4">
        ...
        <div className="mt-2 flex justify-between items-center">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => onEdit('asset', listing.id)}
          >
...
export default AssetListingCard;