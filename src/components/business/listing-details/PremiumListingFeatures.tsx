...
//           .update({
//             [type === "featured_listing" ? "is_featured" : "is_priority"]: true,
//             [type === "featured_listing" ? "featured_until" : "priority_until"]: 
//               new Date(Date.now() + (type === "featured_listing" ? 30 : 7) * 24 * 60 * 60 * 1000).toISOString()
//           })
//           .eq('id', listingId);

//         if (error) throw error;
        
//         await activateFeature(type, type === "featured_listing" ? 30 : 7);
